...
def main():
    ...
    page='<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Zephyr Translation Review — Sections</title><style>'+css+'</style><header><h1>Zephyr · Korean–English review / 번역 검토</h1><p>Korean is authoritative. Chinese is supporting context. Blade Shot revision included.</p><p>Start reading below. <b>Next</b> opens the next review section; no search is required. Sections follow translation batches, not story chapters.</p><details><summary>Choose a section / 구간 선택</summary><ol>'+''.join(links)+'</ol></details><small>Send corrections with the R/M number. Search using your browser’s Find on Page. This version needs no JavaScript.</small></header><main>'+''.join(sections[1:]+sections[:1])+'</main></html>'
