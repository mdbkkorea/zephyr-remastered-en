...
这个项目从一段童年回忆开始，也会继续靠一次次游玩、校对和反馈慢慢变得更好。汉化工具与后续更新都会免费提供；如果它让你重新享受了这段冒险，也愿意支持我继续优化译文、修复显示问题和维护工具，欢迎自愿请我喝杯咖啡。

是否支持完全随意，不影响下载、使用或更新，也不附带付费内容、优先支持或额外服务。你的反馈、截图和一句“玩得开心”，同样是对这个项目最珍贵的帮助。

<p align="center">
  <img src="docs/support/wechat-pay.jpg" alt="微信收款码：自愿支持《西风狂诗曲》重制版简体中文重译计划" width="320">
  <br>
  <sub>微信扫码自愿支持 · 请优先购买正版支持原作</sub>
</p>
